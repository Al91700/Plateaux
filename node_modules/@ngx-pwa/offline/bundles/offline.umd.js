...
var Network = /** @class */ (function () {
     ...
     */
    function () {
        this.onlineChanges = !_angular_common.isPlatformBrowser(this.platformId) ? rxjs.of(true) : rxjs.merge(rxjs_operators.startWith(this.online), rxjs.fromEvent(document, 'online').pipe(rxjs_operators.mapTo(true)), rxjs.fromEvent(document, 'offline').pipe(rxjs_operators.mapTo(false)));
    };
    ...
    /** @nocollapse */ Network.ngInjectableDef = i0.defineInjectable({ factory: function Network_Factory() { return new Network(i0.inject(i1.Router), i0.inject(i0.PLATFORM_ID), i0.inject(OFFLINE_ROUTE_OFFLINE), i0.inject(OFFLINE_ROUTE_UNAVAILABLE)); }, token: Network, providedIn: "root" });
    return Network;
}());
/**
